...
def generate_dummy_contracts_data():
    ...
    Row 7 = EDGE CASE - Contract with INCORRECT buyer name "Buyer A Department" (Supplier 6)
    Row 8 = EDGE CASE - Contract with INCORRECT buyer name "DWP Office" (Supplier 8)
    Row 9 = EDGE CASE - Contract with INCORRECT buyer name "Buyer B Corp" (Supplier 10)
...
def generate_dummy_mi_data():
    ...
    Row 14: EDGE CASE - Supplier 7 reports "Buyer A Department" (same incorrect name as contract Row 7, but DIFFERENT supplier)
    Row 15: EDGE CASE - Supplier 9 reports "DWP Office" (same incorrect name as contract Row 8, but DIFFERENT supplier)
    Row 16: EDGE CASE - Supplier 11 reports "Buyer B Corp" (same incorrect name as contract Row 9, but DIFFERENT supplier)
